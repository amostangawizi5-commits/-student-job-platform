...
class AdminRoleTheme {
  static const Color primary = Color(0xFF0E3A5D);
  static const Color primaryDark = Color(0xFF153E63);
  static const Color accent = Color(0xFFEF6C00);
  static const Color accentSoft = Color(0xFFFFE0B2);
  static const Color info = Color(0xFF3B82F6);
  static const Color ink = Color(0xFF1E293B);
  static const Color warmSurface = Color(0xFFF7F0E8);
  static const Color chipSurface = Color(0xFFFFF7EC);
  static const Color chipBorder = Color(0xFFF7D8AA);
}
